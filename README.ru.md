...
Одна иконка в строке меню для лимитов всех оплаченных AI-подписок.

English version: [README.md](README.md).

<p align="center">
  <img src="docs/images/menubar.png" width="300" alt="Строка меню: треугольник предупреждения, C33%, !X1% и G68%">
</p>

`C` — Claude, `X` — Codex, `G` — Grok. Числа означают **остаток**, а не расход.
`!` помечает сервис, который вот-вот кончится; иконка тоже меняется, потому что
macOS рисует текст в строке меню монохромным шаблоном и цвет там срезается.

<p align="center">
  <img src="docs/images/dashboard.png" width="430" alt="Панель со списком Claude, Codex, Grok и балансов; Codex на 1% красным">
</p>

Скриншоты сняты в демонстрационном режиме (`--demo`): данные вымышленные.
...
<p align="center">
  <img src="docs/images/settings.png" width="500" alt="Настройки, вкладка «Общие»: пороги смены и предупреждения, состояние уведомлений, переключатели сервисов">
</p>

<p align="center">
  <img src="docs/images/accounts.png" width="500" alt="Настройки, вкладка «Аккаунты»: пронумерованные аккаунты с полями переименования, стрелками приоритета и кнопкой удаления">
</p>
...
<p align="center">
  <img src="docs/images/extension.png" width="330" alt="Окно расширения: зелёный статус «Подключено», выбор аккаунта и кнопка сохранения сессии">
</p>
